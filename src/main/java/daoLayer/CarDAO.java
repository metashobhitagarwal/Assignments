...
public class CarDAO {
	...
	public boolean addCar(CarVO car){
		...
		try{
			...
			if(prepareStatement != null){
				...
				prepareStatement.setString(9, car.getIsACPresent());
				prepareStatement.setString(10, car.getIsPowerSteeringPresent());
				prepareStatement.setString(11, car.getIsAccessoryKitPresent());
		...
		try{
			...
			if(resultSet != null){
				...
				while(resultSet.next()){
					...
					car.setIsACPresent(resultSet.getString(8));
					car.setIsPowerSteeringPresent(resultSet.getString(9));
					car.setIsAccessoryKitPresent(resultSet.getString(10));
					listOfCars.add(car);
				}
			}
	...
	public boolean updateCar(CarVO car){
		...
		try{
			...
			if(prepareStatement != null){
				...
				prepareStatement.setString(8, car.getIsACPresent());
				prepareStatement.setString(9, car.getIsPowerSteeringPresent());
				prepareStatement.setString(10, car.getIsAccessoryKitPresent());
	...
	public List<CarVO> selectCarBasedOnModelNumber(String modelNumber){
		
		System.out.println("mode dao: "+modelNumber);
		String sqlQuery = "SELECT CompanyName , ModelNumber , Name , FuelCapacity, Milege, Price, RoadTax, AC, PowerSteering , AccessoryKit FROM car WHERE ModelNumber = ?;";
		...
		try{
			...
			if(prepareStatement != null){
				...
				prepareStatement.setString(1, modelNumber);
