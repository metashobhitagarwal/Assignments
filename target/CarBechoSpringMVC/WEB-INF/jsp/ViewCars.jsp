...
<%@page import="service.CarServiceImpl"%>
<%@page import="factory.FacadeFactory"%>
...
<body>
	<table>
		...
		<tr>
			...
			<td><a href="<c:url value='/update/UpdateCar/${lists[status.index].getId()}' />" > Update </a> </td>
			<td><a href="<c:url value='/detailedView/getDetailedView/${lists[status.index].getId()}' />" > Detailed View </a> </td>
		</c:forEach>
	</table>
	<div>
