...
<body>
	<table>
		...
		<tr>
			...
			<td><a href="<c:url value='/DetailedViewCar/${listNotes[status.index]}' />" > Detailed View </a> </td>
			
			<!--   <td><a href="UpdateCar?companyName=${car.getCompanyName()}&
						...
						roadTax=${car.getRoadTax()}&AC=${car.getIsACPresent()}&
						powerSteering=${car.getIsPowerSteeringPresent()}
						&accessoryKit=${car.getIsAccessoryKitPresent()}">
					Edit </a></td>

			<td><a href="DetailedCarView?companyName=${car.getCompanyName()}&
						modalNumber=${car.getModelNumber()}&carName=${car.getName()}&fuelCapacity=
						${car.getFuelCapacity()}&milage=${car.getMilege()}&price=${car.getPrice()}&
						roadTax=${car.getRoadTax()}&AC=${car.getIsACPresent()}&
						powerSteering==${car.getIsPowerSteeringPresent()}&accessoryKit=
						${car.getIsAccessoryKitPresent()}">
					Detailed View </a></td> -->
		</c:forEach>
	</table>
	<div>
