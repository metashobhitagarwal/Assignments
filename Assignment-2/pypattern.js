...
function pyramidByForLoop() {
	...
	document.getElementById("loop1").innerHTML="Pyramid using for loop:";
}
...
function pyramidByWhileLoop() {
	...
	document.getElementById("loop2").innerHTML="Pyramid using while loop:";
}
...
function pyramidByDoWhileLoop() {
	...
	document.getElementById("loop3").innerHTML="Pyramid using do-while loop:";
}